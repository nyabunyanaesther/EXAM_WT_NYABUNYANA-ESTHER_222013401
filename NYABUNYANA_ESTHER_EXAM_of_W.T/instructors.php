...
<form method="post" onsubmit="return confirmInsert();">
    ...
    <label for="ExpertiseArea">ExpertiseArea:</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO instructors(InstructorID, UserID, Bio,ExpertiseArea) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssss", $InstructorID, $UserID, $Bio, $ExpertiseArea);
    // Set parameters and execute
    $InstructorID = $_POST['book_id'];
    $UserID = $_POST['ride_id'];
    $Bio = $_POST['passenger_id'];
    $ExpertiseArea = $_POST['booking_time'];
